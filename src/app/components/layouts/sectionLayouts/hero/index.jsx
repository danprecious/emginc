    ...
    <div className="col-center-center md:mt- lg:mt-12 mt-6">
      ...
      <div className="col-center-center my-4 py-5 md:my-0">
        <p className="text-xs md:text-sm text-center md:w-[70%] px-5">
          <span className="text-gradient text-[1.5em]">...</span>Unlock your brand’s potential with innovative strategies and tailored
          solutions that drive results and elevate your market presence
        </p>
        <div className="my-4 py-3">
          <CustomButton href="/" text="Have a project?" />
        </div>
      </div>
